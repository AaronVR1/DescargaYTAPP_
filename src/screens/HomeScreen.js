...
export default function HomeScreen() {
  ...
  const handleDownload = async (quality = 'high') => {
    ...
    try {
      const downloadData = await getDownloadLinks(url);
      ...
      const fileUri = FileSystem.documentDirectory + `${videoInfo.title}.mp4`;
    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Descarga tus videos favoritos</Text>
        </View>
